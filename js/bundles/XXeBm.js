...
var XXeBm = function (_Component) {
  _inherits(XXeBm, _Component);

  function XXeBm() {
    _classCallCheck(this, XXeBm);

    return _possibleConstructorReturn(this, (XXeBm.__proto__ || Object.getPrototypeOf(XXeBm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XXeBm, _indexSoy2.default);

exports.default = XXeBm;
...
exports.templates = exports.XXeBm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XXeBm.
   * @public
   */

  goog.module('XXeBm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XXeBm.render';
  }
...
_metalSoy2.default.register(XXeBm, templates);
exports.XXeBm = XXeBm;
