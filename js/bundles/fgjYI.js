...
var fgjYI = function (_Component) {
  _inherits(fgjYI, _Component);

  function fgjYI() {
    _classCallCheck(this, fgjYI);

    return _possibleConstructorReturn(this, (fgjYI.__proto__ || Object.getPrototypeOf(fgjYI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fgjYI, _indexSoy2.default);

exports.default = fgjYI;
...
exports.templates = exports.fgjYI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fgjYI.
   * @public
   */

  goog.module('fgjYI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fgjYI.render';
  }
...
_metalSoy2.default.register(fgjYI, templates);
exports.fgjYI = fgjYI;
