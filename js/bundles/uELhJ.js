...
var uELhJ = function (_Component) {
  _inherits(uELhJ, _Component);

  function uELhJ() {
    _classCallCheck(this, uELhJ);

    return _possibleConstructorReturn(this, (uELhJ.__proto__ || Object.getPrototypeOf(uELhJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uELhJ, _indexSoy2.default);

exports.default = uELhJ;
...
exports.templates = exports.uELhJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uELhJ.
   * @public
   */

  goog.module('uELhJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uELhJ.render';
  }
...
_metalSoy2.default.register(uELhJ, templates);
exports.uELhJ = uELhJ;
