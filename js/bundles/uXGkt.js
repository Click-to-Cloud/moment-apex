...
var uXGkt = function (_Component) {
  _inherits(uXGkt, _Component);

  function uXGkt() {
    _classCallCheck(this, uXGkt);

    return _possibleConstructorReturn(this, (uXGkt.__proto__ || Object.getPrototypeOf(uXGkt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uXGkt, _indexSoy2.default);

exports.default = uXGkt;
...
exports.templates = exports.uXGkt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uXGkt.
   * @public
   */

  goog.module('uXGkt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uXGkt.render';
  }
...
_metalSoy2.default.register(uXGkt, templates);
exports.uXGkt = uXGkt;
