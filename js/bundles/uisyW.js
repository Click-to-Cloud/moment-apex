...
var uisyW = function (_Component) {
  _inherits(uisyW, _Component);

  function uisyW() {
    _classCallCheck(this, uisyW);

    return _possibleConstructorReturn(this, (uisyW.__proto__ || Object.getPrototypeOf(uisyW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uisyW, _indexSoy2.default);

exports.default = uisyW;
...
exports.templates = exports.uisyW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uisyW.
   * @public
   */

  goog.module('uisyW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uisyW.render';
  }
...
_metalSoy2.default.register(uisyW, templates);
exports.uisyW = uisyW;
