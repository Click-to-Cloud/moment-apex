...
var zbEzb = function (_Component) {
  _inherits(zbEzb, _Component);

  function zbEzb() {
    _classCallCheck(this, zbEzb);

    return _possibleConstructorReturn(this, (zbEzb.__proto__ || Object.getPrototypeOf(zbEzb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zbEzb, _indexSoy2.default);

exports.default = zbEzb;
...
exports.templates = exports.zbEzb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zbEzb.
   * @public
   */

  goog.module('zbEzb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zbEzb.render';
  }
...
_metalSoy2.default.register(zbEzb, templates);
exports.zbEzb = zbEzb;
